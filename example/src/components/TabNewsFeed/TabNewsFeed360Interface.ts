...
import NewsFeed from "./NewsFeed/QihooInterface/NewsFeed";

class TabNewsFeed360Interface extends TabComponent {
    protected async render(): Promise<void> {
        ...
        await Promise.all([
            // 创建信息流
            NewsFeed.build(element.find('.tab-news-feed'), categoryData),
            // 创建右上角
...
export default TabNewsFeed360Interface;